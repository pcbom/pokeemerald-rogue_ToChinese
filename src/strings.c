...
const u8 gText_MainMenuContinueRun[] = _("继续冒险");
...
const u8 gText_BirchBrendan[] = _("小悠");
const u8 gText_BirchMay[] = _("小遥");
const u8 gText_BirchRed[] = _("赤");
const u8 gText_BirchLeaf[] = _("叶子");
...
const u8 gText_Classic[] = _("经典");
const u8 gText_Modern[] = _("现代");
...
const u8 gText_MenuOptionExit[] = _("结束");
...
const u8 gText_OptionGame[] = _("游戏");
const u8 gText_OptionGraphics[] = _("显示");
const u8 gText_OptionUI[] = _("UI");
const u8 gText_OptionAudio[] = _("声音");
const u8 gText_TextSpeed[] = _("文本速度");
const u8 gText_BattleSceneWild[] = _("野外对战动画");
const u8 gText_BattleSceneTrainer[] = _("训练师对战动画");
const u8 gText_BattleSceneKey[] = _("重要对战动画");
const u8 gText_BattleStyle[] = _("Battle Style");
const u8 gText_AutoRun[] = _("跑步按钮");
const u8 gText_NicknameMode[] = _("起名设置");
const u8 gText_TimeOfDay[] = _("昼夜交替");
const u8 gText_Seasons[] = _("四季交替");
const u8 gText_Weather[] = _("天气");
const u8 gText_Sound[] = _("音乐播放");
const u8 gText_PopupSound[] = _("提示音");
const u8 gText_SoundChannelBGM[] = _("音乐音量");
const u8 gText_SoundChannelSE[] = _("UI音量");
const u8 gText_SoundChannelBattleSE[] = _("对战音乐音量");
const u8 gText_SoundLowHealth[] = _("低HP音效");
const u8 gText_Frame[] = _("边框");
const u8 gText_OptionMenuCancel[] = _("取消");
const u8 gText_ButtonMode[] = _("按键模式");
const u8 gText_TextSpeedSlow[] = _("{COLOR LIGHT_RED}{SHADOW LIGHT_GREEN}慢");
const u8 gText_TextSpeedMid[] = _("{SHADOW LIGHT_GREEN}快");
const u8 gText_TextSpeedFast[] = _("{COLOR LIGHT_BLUE}{SHADOW BLUE}瞬间");
const u8 gText_BattleSceneOn[] = _("{COLOR LIGHT_BLUE}{SHADOW BLUE}开");
const u8 gText_BattleSceneOff[] = _("{COLOR LIGHT_RED}{SHADOW LIGHT_GREEN}关");
...
const u8 gText_AutoRunHold[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}保持");
const u8 gText_AutoRunToggle[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}切换");
const u8 gText_TextNicknameAsk[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}询问");
const u8 gText_TextNicknameAlways[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}总是");
const u8 gText_TextNicknameNever[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}从不");
const u8 gText_TextNicknameRandom[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}自动");
...
const u8 gText_TimeOfDayVisible[] = _("{COLOR LIGHT_BLUE}{SHADOW BLUE}显示");
const u8 gText_TimeOfDayHidden[] = _("{COLOR LIGHT_RED}{SHADOW LIGHT_GREEN}隐藏");
...
const u8 gText_ButtonTypeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}标准");
...
const u8 gText_MenuQuickSave[] = _("快速存档");
const u8 gText_MenuRetireRun[] = _("放弃冒险");
...
const u8 gText_PkmnsNickname[] = _("{STR_VAR_1}的名字?");
const u8 gText_TellHimTheWords[] = _("Tell him the words.");
const u8 gText_NamePokemonHub[] = _("村庄的名字?");
...
const u8 gText_SavingQuests[] = _("探索");
const u8 gText_SavingTime[] = _("游戏时间");
